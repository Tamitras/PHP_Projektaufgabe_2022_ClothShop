    ...
    <div class="row pb-2 pt-1 align-items-center text-white">
        ...
        <div class="col d-flex justify-content-center">
            ...
            <!-- <form class="d-flex flex-grow-1">
                <input class="form-control me-2" type="search" placeholder="Suche nach Produkt" aria-label="Search">
                <button class="btn btn-outline-success" type="submit">Search</button>
            </form> -->
            <form action="" class="flex-grow-1">
                <div class="input-group">
                    <input type="text" class="form-control form-control-lg" placeholder="Produkte suchen">
                    <button type="submit" class="input-group-text btn-success bg-danger">
